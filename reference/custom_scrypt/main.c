...
printf("%ld\n",sizeof(m));
sha256_starts(&c);
  sha256_set_state(&c,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000);
//sha256_set_state(&c,0x9524c593,0x05c56713,0x16e669ba,0x2d2810a0,0x07e86e37,0x2f56a9da,0xcd5bce69,0x7a78da2d);
sha256_update( &c, (uint8*)(m3), 16);

sha256_finishx( &c, digest,1);
